...
//
//		public: static rfk::ClassTemplateInstance const& staticGetArchetype() noexcept
//		{
//			static bool initialized = false;
//
//			//TODO: Change Name without template types
//			//TODO: Change combine hash of all archetypes
//			static rfk::ClassTemplateInstance type("Vector", 9918884327437644209u, sizeof(Vector<T, U, V>), true, );
//
//			if (!initialized)
//			{
//				initialized = true;
...
//		}
//
//		RFK_UNPACK_IF_NOT_PARSING(private: static inline rfk::ClassTemplateInstanceRegisterer _rfk_registerer = staticGetArchetype(); rfk::ForceGenerateSymbol<&_rfk_registerer> _rfk_forceRegister() = delete;)
//
