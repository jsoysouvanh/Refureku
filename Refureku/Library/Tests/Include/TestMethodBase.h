...
class CLASS() TestMethodBaseClass
{
	...
	protected:
		...
		METHOD()
		virtual void virtualMethod() noexcept { }
	...
	public:
		...
		METHOD()
		void funcWithParams1(int, int, int) const { }
...
class CLASS() TestMethodBaseClassChild : public TestMethodBaseClass
{
	public:
		METHOD()
		/* virtual */ void virtualMethod() noexcept override { }

		METHOD()
		/* virtual */ void virtualMethod2() noexcept /* override */ { }
