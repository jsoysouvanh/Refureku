...
MethodBase::MethodBase(std::string&& name, std::size_t id, Type const& returnType, std::unique_ptr<ICallable>&& internalMethod, EMethodFlags flags, Entity const* outerEntity) noexcept:
