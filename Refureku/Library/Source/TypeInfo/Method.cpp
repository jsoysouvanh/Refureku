...
Method::Method(std::string&& methodName, uint64 methodId, EAccessSpecifier accessSpecifier, Archetype const* methodOwnerType, std::shared_ptr<ICallable>&& internalMethod) noexcept:
