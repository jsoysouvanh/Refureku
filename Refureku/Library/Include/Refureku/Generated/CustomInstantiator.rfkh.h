...
if constexpr (!std::is_same_v<ChildClass, CustomInstantiator>) const_cast<rfk::Struct&>(thisClass).addSubclass(childClass);\
}\
\
\
...
template <> REFUREKU_API rfk::Archetype const* rfk::getArchetype<CustomInstantiator>() noexcept;\
