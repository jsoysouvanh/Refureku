...
friend implements_template1__rfk_registerChildClass<ParseAllNested, void, void(rfk::StructAPI&)>; \
\
...
if constexpr (!std::is_same_v<ChildClass, ParseAllNested>) const_cast<rfk::StructAPI&>(thisClass).addSubclass(childClass);\
}\
\
\
...
template <> REFUREKU_API rfk::ArchetypeAPI const* rfk::getArchetypeAPI<ParseAllNested>() noexcept;\
