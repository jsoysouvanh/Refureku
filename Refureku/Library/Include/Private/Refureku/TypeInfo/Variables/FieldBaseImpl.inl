...
inline FieldBaseAPI::FieldBaseImpl::FieldBaseImpl(char const* name, std::size_t id, TypeAPI const& type, EFieldFlags flags, StructAPI const* owner, Entity const* outerEntity) noexcept:
