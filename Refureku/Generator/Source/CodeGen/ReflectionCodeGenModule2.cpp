...
std::hash<std::string> ReflectionCodeGenModule2::_stringHasher;

ReflectionCodeGenModule2::ReflectionCodeGenModule2() noexcept:
...
ReflectionCodeGenModule2::ReflectionCodeGenModule2(ReflectionCodeGenModule2 const&) noexcept:
	ReflectionCodeGenModule2()
{
}

ReflectionCodeGenModule2* ReflectionCodeGenModule2::clone() const noexcept
{
	return new ReflectionCodeGenModule2(*this);
}

bool ReflectionCodeGenModule2::initialGenerateHeaderFileHeaderCode(kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
	reset();
...
kodgen::ETraversalBehaviour	ReflectionCodeGenModule2::generateHeaderFileHeaderCodeForEntity(kodgen::EntityInfo const& entity, kodgen::MacroCodeGenEnv& env, std::string& /* inout_result */) noexcept
{
...
kodgen::ETraversalBehaviour	ReflectionCodeGenModule2::generateClassFooterCodeForEntity(kodgen::EntityInfo const& entity, kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
	kodgen::ETraversalBehaviour result = kodgen::ETraversalBehaviour::Recurse;
...
kodgen::ETraversalBehaviour ReflectionCodeGenModule2::generateHeaderFileFooterCodeForEntity(kodgen::EntityInfo const& entity, kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
	kodgen::ETraversalBehaviour result = kodgen::ETraversalBehaviour::Recurse;
...
bool ReflectionCodeGenModule2::initialGenerateSourceFileHeaderCode(kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
...
kodgen::ETraversalBehaviour ReflectionCodeGenModule2::generateSourceFileHeaderCodeForEntity(kodgen::EntityInfo const& entity, kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
	kodgen::ETraversalBehaviour result = kodgen::ETraversalBehaviour::Recurse;
...
void ReflectionCodeGenModule2::includeHeaderFileHeaders(kodgen::MacroCodeGenEnv& env, std::string& inout_result) const noexcept
{
...
void ReflectionCodeGenModule2::includeSourceFileHeaders(kodgen::MacroCodeGenEnv& env, std::string& inout_result) const noexcept
{
...
void ReflectionCodeGenModule2::declareFriendClasses(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string& inout_result) const noexcept
{
...
void ReflectionCodeGenModule2::declareStaticGetArchetypeMethod(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string& inout_result) const noexcept
{
...
void ReflectionCodeGenModule2::declareGetArchetypeMethodIfInheritFromObject(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string& inout_result) const noexcept
{
...
void ReflectionCodeGenModule2::defineStaticGetArchetypeMethod(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
...
std::string ReflectionCodeGenModule2::computePropertyVariableName(kodgen::EntityInfo const& entity, kodgen::uint8 propertyIndex) noexcept
{
	return "property_" + getEntityId(entity) + "_" + entity.properties[propertyIndex].name + "_" + std::to_string(propertyIndex);
}

std::string ReflectionCodeGenModule2::computeGetNestedEnumMethodName(kodgen::NestedEnumInfo const& nestedEnum) noexcept
{
	return "_rfk_getNestedEnum_" + nestedEnum.name;
}

bool ReflectionCodeGenModule2::isPublicClass(kodgen::StructClassInfo const& class_) noexcept
{
...
std::string ReflectionCodeGenModule2::computeClassTemplateEntityId(kodgen::StructClassInfo const& class_, kodgen::EntityInfo const& entity) noexcept
{
	return "std::hash<std::string>()(std::string(\"" + entity.id + "\") + rfk::generated::getTypename<" + class_.type.getName() + ">())";
}

void ReflectionCodeGenModule2::beginHiddenGeneratedCode(kodgen::MacroCodeGenEnv& /*env*/, std::string& inout_result) noexcept
{
...
void ReflectionCodeGenModule2::endHiddenGeneratedCode(kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
	if (_isGeneratingHiddenCode)
	{
		_isGeneratingHiddenCode = false;
...
void ReflectionCodeGenModule2::reset() noexcept
{
	_isGeneratingHiddenCode = false;
	_nonPublicEnums.clear();
}

void ReflectionCodeGenModule2::checkHiddenGeneratedCodeState() const noexcept
{
	assert(!_isGeneratingHiddenCode);
}

void ReflectionCodeGenModule2::fillEntityProperties(kodgen::EntityInfo const& entity, kodgen::MacroCodeGenEnv& env, std::string const& generatedEntityVarName, std::string& inout_result) noexcept
{
...
void ReflectionCodeGenModule2::fillClassParents(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string const& generatedEntityVarName, std::string& inout_result) noexcept
{
...
void ReflectionCodeGenModule2::fillClassFields(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string generatedClassRefExpression, std::string& inout_result) noexcept
{
...
void ReflectionCodeGenModule2::fillClassMethods(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string const& generatedEntityVarName, std::string& inout_result) noexcept
{
...
void ReflectionCodeGenModule2::fillClassNestedArchetypes(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string const& generatedEntityVarName, std::string& inout_result) noexcept
{
...
void ReflectionCodeGenModule2::defineGetArchetypeMethodIfInheritFromObject(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string& inout_result) const noexcept
{
	if (env.getFileParsingResult()->structClassTree.isBaseOf("rfk::Object", structClass.getFullName()))
	{
		std::string returnType = (structClass.isClass()) ? "rfk::ClassAPI" : "rfk::StructAPI";
...
void ReflectionCodeGenModule2::declareGetArchetypeTemplateSpecialization(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string& inout_result) const noexcept
{
...
void ReflectionCodeGenModule2::defineGetArchetypeTemplateSpecialization(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string& inout_result) const noexcept
{
...
void ReflectionCodeGenModule2::declareAndDefineRegisterChildClassMethod(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
...
void ReflectionCodeGenModule2::declareGetNestedEnumMethods(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
...
void ReflectionCodeGenModule2::defineGetNestedEnumMethods(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
	for (kodgen::NestedEnumInfo const& nestedEnum : structClass.nestedEnums)
	{
...
void ReflectionCodeGenModule2::declareAndDefineClassRegistererVariable(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string& inout_result) const noexcept
{
...
void ReflectionCodeGenModule2::declareAndDefineClassTemplateStaticGetArchetypeMethod(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
...
void ReflectionCodeGenModule2::declareAndDefineClassTemplateGetArchetypeMethodIfInheritFromObject(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string& inout_result) const noexcept
{
	if (env.getFileParsingResult()->structClassTree.isBaseOf("rfk::Object", structClass.getFullName()))
	{
...
void ReflectionCodeGenModule2::declareAndDefineClassTemplateRegistererField(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string& inout_result) const noexcept
{
	//Define the registrator only when there is no outer entity.
	//If there is an outer entity, it will register its nested entities to the database itself.
	if (structClass.outerEntity == nullptr)
...
void ReflectionCodeGenModule2::fillClassTemplateArguments(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string& inout_result) const noexcept
{
...
void ReflectionCodeGenModule2::defineClassTemplateGetArchetypeTemplateSpecialization(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
...
void ReflectionCodeGenModule2::fillClassTemplateParameters(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string& inout_result) const noexcept
{
...
void ReflectionCodeGenModule2::declareAndDefineClassTemplateRegistererVariable(kodgen::StructClassInfo const& structClass, kodgen::MacroCodeGenEnv& env, std::string& inout_result) const noexcept
{
	assert(structClass.type.isTemplateType());
...
std::string ReflectionCodeGenModule2::convertEntityTypeToEntityKind(kodgen::EEntityType entityType) noexcept
{
	switch (entityType)
	{
		case kodgen::EEntityType::Struct:
...
kodgen::uint16 ReflectionCodeGenModule2::computeRefurekuFieldFlags(kodgen::FieldInfo const& field) noexcept
{
...
kodgen::uint16 ReflectionCodeGenModule2::computeRefurekuMethodFlags(kodgen::MethodInfo const& method) noexcept
{
	kodgen::uint16 result = 0;
...
std::string ReflectionCodeGenModule2::computeFullMethodPointerType(kodgen::StructClassInfo const& classInfo, kodgen::MethodInfo const& method) noexcept
{
...
bool ReflectionCodeGenModule2::isRegisteredNonPublicEnum(kodgen::EnumInfo const& nestedEnum) const noexcept
{
	return _nonPublicEnums.find(&nestedEnum) != _nonPublicEnums.cend();
}

void ReflectionCodeGenModule2::declareGetEnumTemplateSpecialization(kodgen::EnumInfo const& enum_, kodgen::MacroCodeGenEnv& env, std::string& inout_result) const noexcept
{
...
void ReflectionCodeGenModule2::defineGetEnumTemplateSpecialization(kodgen::EnumInfo const& enum_, kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
	//Don't generate template specialization code on non-public enums
	//Code is generated by the outer class itself
	if (!isRegisteredNonPublicEnum(enum_))
...
void ReflectionCodeGenModule2::defineGetEnumContent(kodgen::EnumInfo const& enum_, kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
	inout_result += "{" + env.getSeparator() +
		"static bool initialized = false;" + env.getSeparator() +
...
void ReflectionCodeGenModule2::declareAndDefineEnumRegistererVariable(kodgen::EnumInfo const& enum_, kodgen::MacroCodeGenEnv& env, std::string& inout_result) const noexcept
{
...
void ReflectionCodeGenModule2::declareGetVariableFunction(kodgen::VariableInfo const& variable, kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
	beginHiddenGeneratedCode(env, inout_result);
...
void ReflectionCodeGenModule2::defineGetVariableFunction(kodgen::VariableInfo const& variable, kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
...
void ReflectionCodeGenModule2::declareAndDefineVariableRegistererVariable(kodgen::VariableInfo const& variable, kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
...
kodgen::uint8 ReflectionCodeGenModule2::computeRefurekuVariableFlags(kodgen::VariableInfo const& variable) noexcept
{
...
std::string ReflectionCodeGenModule2::computeGetVariableFunctionName(kodgen::VariableInfo const& variable) noexcept
{
	return "getVariable" + getEntityId(variable);;
}

void ReflectionCodeGenModule2::declareGetFunctionFunction(kodgen::FunctionInfo const& function, kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
	beginHiddenGeneratedCode(env, inout_result);
...
void ReflectionCodeGenModule2::defineGetFunctionFunction(kodgen::FunctionInfo const& function, kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
...
void ReflectionCodeGenModule2::declareAndDefineFunctionRegistererVariable(kodgen::FunctionInfo const& function, kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
...
kodgen::uint8 ReflectionCodeGenModule2::computeRefurekuFunctionFlags(kodgen::FunctionInfo const& function) noexcept
{
	kodgen::uint8 result = 0u;
...
std::string ReflectionCodeGenModule2::computeGetFunctionFunctionName(kodgen::FunctionInfo const& function) noexcept
{
	return "getFunction" + getEntityId(function);
}

void ReflectionCodeGenModule2::declareAndDefineGetNamespaceFragmentFunction(kodgen::NamespaceInfo const& namespace_, kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
...
void ReflectionCodeGenModule2::declareAndDefineNamespaceFragmentRegistererVariable(kodgen::NamespaceInfo const& namespace_, kodgen::MacroCodeGenEnv& env, std::string& inout_result) noexcept
{
...
std::string ReflectionCodeGenModule2::computeGetNamespaceFragmentFunctionName(kodgen::NamespaceInfo const& namespace_, fs::path const& sourceFile) noexcept
{
	return "getNamespaceFragment_" + getEntityId(namespace_) + "_" + std::to_string(_stringHasher(sourceFile.string()));
}

std::string ReflectionCodeGenModule2::computeNamespaceFragmentRegistererName(kodgen::NamespaceInfo const& namespace_, fs::path const& sourceFile) noexcept
{
