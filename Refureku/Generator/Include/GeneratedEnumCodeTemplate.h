...
namespace rfk
{
	class GeneratedEnumCodeTemplate : public GeneratedEntityCodeTemplate
	{
		private:
			...
			std::string generateGetEnumSpecialization(kodgen::GeneratedFile& generatedFile, kodgen::EnumInfo const& enumInfo)	const	noexcept;
			std::string generateRegistrationMacro(kodgen::GeneratedFile& generatedFile, kodgen::EnumInfo const& enumInfo)		const	noexcept;
