...
namespace rfk
{
	class ReflectionCodeGenModule : public kodgen::MacroCodeGenModule
	{
		private:
			...
			*/
			inline static std::string		convertEntityTypeToEntityKind(kodgen::EEntityType entityType)						noexcept;
			...
			*/
			inline static kodgen::uint16	computeRefurekuFieldFlags(kodgen::FieldInfo const& field)							noexcept;
