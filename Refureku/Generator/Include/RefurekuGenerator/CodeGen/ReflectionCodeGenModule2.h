...
namespace rfk
{
	class ReflectionCodeGenModule2 : public kodgen::MacroCodeGenModule
	{
		private:
		...
		*/
		...
		protected:
		virtual ReflectionCodeGenModule2*	clone()																		const	noexcept	override;
		...
		public:
		ReflectionCodeGenModule2()								noexcept;
		ReflectionCodeGenModule2(ReflectionCodeGenModule2 const&)	noexcept;
	};

#include "RefurekuGenerator/CodeGen/ReflectionCodeGenModule2.inl"
}